...
@section('content')
    ...
    <div class="container">
        ...
        @endif
        <div class="card">
            <form action="{{url('/profileupdate')}}" class="mt-3" method="POST">
                @csrf
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-8">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jeniskelamin" id="" class="form-control">
                                ...
                                @elseif(Auth::user()->jeniskelamin == 'Perempuan')
                                    <option value="">Choose</option>
                                    <option value="Laki-Laki">Laki-Laki</option>
                                    <option value="Perempuan" selected="selected">Perempuan</option>
                                @elseif((Auth::user()->jeniskelamin == NULL))
                                    <option value="">Choose</option>
                                    <option value="Laki-Laki">Laki-Laki</option>
                                    <option value="Perempuan">Perempuan</option>
                                @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bidangilmu" class="form-control" value="{{$auth->bidangilmu}}">
                        </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th> </th>
                                    <th class="text-center"><b>SD</b></th>
                                    <th class="text-center"><b>SMP</b></th>
                                    <th class="text-center"><b>SMA</b></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>Nama Instansi</td>
                                    <td><input type="text" class="form-control" name="sd" value="{{optional($pendidikan)->sd}}"></td>
                                    <td><input type="text" class="form-control" name="smp" value="{{optional($pendidikan)->smp}}"></td>
                                    <td><input type="text" class="form-control" name="sma" value="{{optional($pendidikan)->sma}}"></td>
                                </tr>
                                <tr>
                                    <td>Jurusan</td>
                                    <td><input type="text" class="form-control" name="jurusansd" value="{{optional($pendidikan)->jurusansd}}"></td>
                                    <td><input type="text" class="form-control" name="jurusansmp" value="{{optional($pendidikan)->jurusansmp}}"></td>
                                    <td><input type="text" class="form-control" name="jurusansma" value="{{optional($pendidikan)->jurusansma}}"></td>
                                </tr>
                                <tr>
                                    <td>Tahun Masuk - Lulus</td>
                                    <td><input type="text" class="form-control" name="tanggalsd" value="{{optional($pendidikan)->tahunsd}}"></td>
                                    <td><input type="text" class="form-control" name="tanggalsmp" value="{{optional($pendidikan)->tahunsmp}}"></td>
                                    <td><input type="text" class="form-control" name="tanggalsma" value="{{optional($pendidikan)->tahunsma}}"></td>
                                </tr>
                            </tbody>
                        </table>
