...
<body>  
    ...
    <div class="lembarpengesahan">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td width="1%" valign="top"> :</td>
                <td width="49%" valign="top">Teknik Informatika</td>
            </tr>
            <tr>
                <td width="5%" valign="top"> </td>
            ...
            <tr>
                ...
                <td width="5%" valign="top"></td>
                <td width="45%" valign="top" align="center">Jakarta, <?php echo date("d/m/Y"); ?></td>
            </tr>
    ...
    <div class="pendahuluan">
        <script type="text/php">
            $pendahuluan = $PAGE_NUM;
        </script>
        <input type="hidden" id="pendahuluan" value="0">
    ...
    <div class="susunanorgansiasi">
        <span><b>Lampiran 2. Susunan Organisasi Tim Penyusun dan Pembagian Tugas</b></span>
    ...
    <div>
            <p id="nomorpendahuluan"></p>
    </div>

    <script type="text/javascript"> 
        $halamanpendahuluan = document.getElementById('pendahuluan').value;
        document.getElementById('nomorpendahuluan').textContent= $halamanpendahuluan;
    </script>
